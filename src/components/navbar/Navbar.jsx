...
const Navbar = () => {
  ...
  function myFunction() {
    document.getElementById("togg").classList.toggle("change");
  }
  ...
  function closeModalAfterSignIn(){
    setOpen(false);
  }
  return (
    <div className="navbar_container">
      ...
      <div className="menu">
        ...
        <button className="signin" style={{fontWeight:"bold"}} onClick={signinPopup}>{UserLogInStatus?"Sign out":"Sign up"}</button>
        
          
         <div style={{border:'1px solid white',width:'3rem',borderRadius:'15%',display:'flex',justifyContent:'center',backgroundColor:'rgb(248, 68, 100)'}} onClick={wishListRedirect}> <h4 style={{textAlign:'center',width:'1rem',height:'1rem'}}>&#9829;</h4></div>
    
        
      </div>
      <div>
        <div className="sortMenu" id="togg" onClick={myFunction}>
        <div style={{border:'1px solid white',outline:'none',width:'3rem',borderRadius:'15%',display:'flex',justifyContent:'center',backgroundColor:'rgb(248, 68, 100)'}} onClick={wishListRedirect}> <h4 style={{textAlign:'center',width:'1rem',height:'1rem',outline:'none'}}>&#9829;</h4></div>
    
        </div>
      </div>
      <Modal open={openModal} onClose={closeModalAfterSignIn} />
    </div>
  );
};
